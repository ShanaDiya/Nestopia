...
class RentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.0),
            Text(
              'Cost: ₹2000', // Replace with your actual cost data
              style: TextStyle(fontSize: 18.0),
            ),
            SizedBox(height: 8.0),
            Text(
              'Location: Your Location', // Replace with your actual location data
              style: TextStyle(fontSize: 18.0),
            ),
            SizedBox(height: 16.0),
            Text(
      ...
      bottomNavigationBar: MyBottomNavigationBar(currentRoute: '/rent'),
    );
  }
}
